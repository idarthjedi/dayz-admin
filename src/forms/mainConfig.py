...
class Ui_ConfigWindow(QMainWindow):
    def setupUi(self, ConfigWindow):
        ...
        self.pushButton_ProfileLocation = QtWidgets.QPushButton(
            parent=self.tab_directoryconfig
        )
        self.pushButton_ProfileLocation.setObjectName("pushButton_ProfileLocation")
        self.gridLayout.addWidget(
            self.pushButton_ProfileLocation,
            1,
            2,
            1,
            1,
        ...
        self.pushButton_removeXML = QtWidgets.QPushButton(
            parent=self.tab_directoryconfig
        )
        ...
        sizePolicy.setHeightForWidth(
            self.pushButton_addXML.sizePolicy().hasHeightForWidth()
        )
        ...
        self.pushButton_removeJSON = QtWidgets.QPushButton(
            parent=self.tab_directoryconfig
        )
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.pushButton_removeJSON.sizePolicy().hasHeightForWidth()
        )
        ...
        self.pushButton_tradersdirectory = QtWidgets.QPushButton(
            parent=self.tab_marketinformation
        )
        ...
        self.pushButton_marketdirectory = QtWidgets.QPushButton(
            parent=self.tab_marketinformation
        )
    ...
    def retranslateUi(self, ConfigWindow):
        ...
        ConfigWindow.setWindowTitle(
            _translate("MainWindow", "DayZ Admin Tools Config Editor")
        )
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab_directoryconfig),
            _translate("ConfigWindow", "Core Directory Info"),
        )
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab_marketinformation),
            _translate("ConfigWindow", "Market Information"),
        )
    ...
    def getDirectory(self, title: str, start_dir: str):
        ...
        return QFileDialog.getExistingDirectory(
            self, caption=title, directory=start_dir
        )

    def _getMarketLocation(self, status: bool):
        fileName = self.getDirectory(
            "Locate Expansion Market Directory", self.lnProfileLocation.text()
        )
        if fileName:
    ...
    def _getTraderLocation(self, status: bool):
        ...
        fileName = self.getDirectory(
            "Locate Expansion Trader Directory", self.lnProfileLocation.text()
        )
        if fileName:
    ...
    def _getProfileLocation(self, status: bool):
        fileName = self.getDirectory(
            "Locate DayZ Profile Directory", self.lnProfileLocation.text()
        )
        if fileName:
    ...
    def _addJSONLocation(self):
        fileName = self.getDirectory(
            "Locate JSON Directory", self.lnProfileLocation.text()
        )
        if fileName:
    ...
    def _addXMLLocation(self):
        fileName = self.getDirectory(
            "Locate XML Directory", self.lnProfileLocation.text()
        )
        if fileName:
